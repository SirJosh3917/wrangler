...
impl DurableObjects {
    ...
    pub fn api_migrations(&self) -> Option<ApiDurableObjectsMigration> {
        ...
        match &self.migrations {
            Some(migrations) if migrations.len() == 1 => {
                return Some(ApiDurableObjectsMigration {
                    old_tag: None,
                    new_tag: None,
...
impl DurableObjectsClass {
    pub fn binding(&self) -> Binding {
        return Binding::new_durable_object_namespace(
            self.binding.clone(),
